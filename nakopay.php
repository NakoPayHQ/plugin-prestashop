 ...
 *
 * Mirrors the user-facing flow of the Blockonomics PrestaShop module
 * (cart → pick crypto → QR + address page → polling → order completion via
 * webhook) but rewires every internal to the NakoPay API and replaces the
 * Angular checkout with vanilla JS + qrious.
 *
 * @author    NakoPay
 * @license   MIT
 */
